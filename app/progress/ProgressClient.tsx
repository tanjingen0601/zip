...
export default function ProgressClient({ tracks }: { tracks: any[] }) {
  const popNode = {
      ...
      >
        <div className="relative w-16 h-16 flex items-center justify-center">
          ...
          <div className={`
            ...
            ${isCompleted ? 'bg-[#FFD700] shadow-[0_4px_14px_rgba(255,215,0,0.4)] border-4 border-white' : ''}
            ${isInProgress ? 'border-4 border-[#FFD700] bg-white text-yellow-600 font-extrabold text-sm shadow-md' : ''}
        ...
        <span className={`
          ...
          ${isCompleted ? 'text-gray-800 bg-white border border-gray-100 shadow-sm group-hover:border-[#FFD700] transition-colors' : ''}
  ...
  // Prevent divide by zero if tracks array is empty
  const dynamicLineOffset = tracks.length > 0 ? `calc(50% / ${tracks.length})` : '0px';
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#FFFDF6] font-sans text-gray-900">
      ...
      <main className="flex-grow relative overflow-hidden flex flex-col items-center py-12 z-10">
          ...
          <div className="flex flex-col items-center relative z-20">
            <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ type: "spring", stiffness: 200, damping: 15 }} className="relative z-20 flex flex-col items-center">
              <div className="relative w-24 h-24 flex items-center justify-center">
                ...
                <div className="w-20 h-20 rounded-full bg-white border-4 border-[#FFD700] shadow-lg flex items-center justify-center z-10">
        ...
        >
          <button className="flex items-center gap-2 px-8 py-4 bg-[#FFD700] text-gray-900 rounded-full font-bold text-lg hover:bg-yellow-400 transition-all shadow-[0_4px_20px_rgba(255,215,0,0.4)] hover:shadow-[0_8px_25px_rgba(255,215,0,0.6)] transform hover:-translate-y-1 ring-4 ring-yellow-100 active:scale-95">
