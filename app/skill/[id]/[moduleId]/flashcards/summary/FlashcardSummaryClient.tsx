// app/skill/[id]/[moduleId]/flashcards/summary/FlashcardSummaryClient.tsx
'use client';
...
export default function FlashcardSummaryClient({ skillId, moduleId, data }: { skillId: string, moduleId: string, data: any }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#FFFDF6] font-sans text-gray-900">
      ...
      <main className="flex-grow relative flex flex-col items-center py-10 px-4 h-full">
            ...
            {data.cards.map((card: any, index: number) => (
              ...
              >
                ...
                <div className="flex items-start gap-3 text-gray-600 text-sm mt-1">
                  ...
                  {/* Joining the array of strings from the database so it reads smoothly */}
        ...
        >
          <button 
            onClick={() => router.push(`/skill/${skillId}/${moduleId}/quiz`)}
          ...
          <button 
            onClick={() => router.push(`/skill/${skillId}/${moduleId}/flashcards`)}
