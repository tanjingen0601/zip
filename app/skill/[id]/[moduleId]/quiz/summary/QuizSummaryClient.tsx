// app/skill/[id]/[moduleId]/quiz/summary/QuizSummaryClient.tsx
'use client';
...
function QuizSummaryContent({ skillId, moduleId, title, totalQuestions }: { skillId: string, moduleId: string, title: string, totalQuestions: number }) {
  ...
  return (
    <main className="flex-grow relative flex flex-col items-center justify-center py-8 px-4 h-full min-h-[calc(100vh-5rem)] overflow-hidden">
      ...
      <div className="w-full max-w-xl mx-auto flex flex-col items-center gap-8 relative z-10">
        ...
        >
          ...
          <div className="flex justify-center gap-12 w-full mb-8 border-b border-gray-100 pb-8">
            <div className="flex flex-col items-center">
              ...
              <span className="font-display font-bold text-xl text-gray-800">4m 32s</span>
            </div>
        ...
        >
          <button 
            onClick={() => router.push(`/skill/${skillId}/${moduleId}/quiz?mode=review`)}
...
export default function QuizSummaryClient({ skillId, moduleId, title, totalQuestions }: { skillId: string, moduleId: string, title: string, totalQuestions: number }) {
  return (
    <div className="min-h-screen flex flex-col bg-[#FFFDF6] font-sans text-gray-900">
      ...
      <Suspense fallback={<div className="flex-grow flex items-center justify-center">Loading results...</div>}>
        <QuizSummaryContent skillId={skillId} moduleId={moduleId} title={title} totalQuestions={totalQuestions} />
      </Suspense>
