// app/skill/[id]/[moduleId]/summary/SummaryClient.tsx
'use client';
...
export default function SummaryClient({ data }: { data: any }) {
            ...
            <div className="p-8 md:p-12 space-y-12 bg-white">
              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-6 mt-6">
                  {data.coreConcepts.map((concept: any, i: number) => {
                ...
                <div className="mt-6 bg-[#18181B] rounded-2xl p-6 md:p-8 font-mono text-sm text-[#D4D4D8]">
                  ...
                  <div className="grid grid-cols-2 gap-8">
                    <div>
                      ...
                      {data.cheatSheet.properties.map((p: string, i: number) => <div key={i} className="mb-1">• {p}</div>)}
                    </div>
                    <div>
                      <p className="text-[#71717A] text-xs font-bold uppercase mb-4">Data Types</p>
                      {data.cheatSheet.dataTypes.map((t: string, i: number) => <div key={i} className="mb-1">• {t}</div>)}
                    </div>
                  </div>
                </div>
              </section>
