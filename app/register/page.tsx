      ...
      <main className="flex-grow flex items-center justify-center px-4 py-12 relative z-10">
        ...
        >
          ...
          <form className="space-y-4" onSubmit={(e) => {
            e.preventDefault();
            // Redirect to onboarding (add routing logic here later)
          }}>
            ...
            <div className="space-y-1">
              ...
              <input 
                type="date" 
                className="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20 outline-none transition-all text-gray-500"
              />
            </div>
            ...
            <button 
              type="submit" 
              className="w-full bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-bold py-3 rounded-lg mt-2 transition-colors"
            >
              Create Account
            </button>
          </form>
          ...
          <div className="space-y-3">
            <button className="w-full flex items-center justify-center gap-2 py-2.5 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-sm font-medium text-gray-700">
            ...
            <button className="w-full flex items-center justify-center gap-2 py-2.5 bg-[#1877F2] hover:bg-[#166FE5] text-white rounded-lg transition-colors text-sm font-medium">
            ...
            <button className="w-full flex items-center justify-center gap-2 py-2.5 bg-black hover:bg-gray-900 text-white rounded-lg transition-colors text-sm font-medium">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
